void plot_laser_position_vs_counts() {
    ...
    // 画像として保存
    c1->SaveAs("AreaCut/laser_position_vs_counts.png");
    ...
    cout << "========================================" << endl;
    cout << "Maximum counts: " << max_counts << " at position " << max_position << " mm (profile " 
         << profile_nums[0] << ")" << endl;
    cout << "\nOutput file created:" << endl;
    cout << "  - AreaCut/laser_position_vs_counts.png" << endl;
    cout << "========================================" << endl;
}
